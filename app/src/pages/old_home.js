             ...
             <div class="columns is-multiline is-vcentered is-centered">
                ...
                <div class="column is-5-desktop is-10-tablet ">
                    <div class="container is-fluid" style={{transform: `translateY(${offset * 0.3}px)`}} >
                        ...
                        <br></br>
                        <p class="is-size-4 has-text-justified is-italic">"Welcome to my home<span class="has-text-grey-light">page</span>. You can probably find me doing either of these activities mentioned in the iconic frame. Apart from that, I find joy in the little things of life and believe in simplicity."</p>
                        <br></br>
